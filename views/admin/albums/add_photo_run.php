<h1>Dodawanie zdjęcia — logi na żywo</h1>
<p class="muted">Album ID: <strong><?= (int)$album_id ?></strong> • Job: <strong><?= htmlspecialchars((string)$job_id, ENT_QUOTES, 'UTF-8') ?></strong></p>
...
(function(){
  ...
  const es = new EventSource('/admin/album/<?= (int)$album_id ?>/add-photo/stream/<?= htmlspecialchars((string)$job_id, ENT_QUOTES, 'UTF-8') ?>');
